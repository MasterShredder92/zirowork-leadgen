...
export default function LoginView({ onLogin }: { onLogin: (user: User, tenantId: string) => void }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (authErr || !data.user) { setError(authErr?.message || "Sign in failed."); setLoading(false); return; }
