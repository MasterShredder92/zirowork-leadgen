          ...
          <div className="swipe-row">
            {CROSS.map((c, i) => (
              <div key={i} style={{ padding: '32px 28px', background: 'var(--color-school-white)', borderRadius: 16, border: '1.5px solid var(--color-school-border)', boxShadow: '0 2px 8px rgba(0,0,0,0.07)' }}>
                ...
                <div style={{ fontSize: 18, fontWeight: 700, color: 'var(--color-school-ink)', marginBottom: 10, lineHeight: 1.3 }}>{c.title}</div>
                <div style={{ fontSize: 15, color: 'var(--color-school-text-4)', lineHeight: 1.75 }}>{c.body}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: '80px 24px', background: 'var(--color-school-white)' }}>
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {FAQS.map((f, i) => (
              <div key={i} style={{ background: 'var(--color-school-white)', borderRadius: 12, border: '1.5px solid var(--color-school-border-2)', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', overflow: 'hidden' }}>
                <button
