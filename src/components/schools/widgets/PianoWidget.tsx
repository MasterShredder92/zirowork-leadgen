...
export default function PianoWidget({ accent }: { accent: string }) {
  ...
  const playNote = useCallback((note: string) => {
    const playOsc = () => {
      ...
      const FREQS: Record<string, number> = { C4:261.6, Cs4:277.2, D4:293.7, Ds4:311.1, E4:329.6, F4:349.2, Fs4:370.0, G4:392.0, Gs4:415.3, A4:440.0, As4:466.2, B4:493.9 };
  ...
  const blackOffset = (noteIdx: number) => {
