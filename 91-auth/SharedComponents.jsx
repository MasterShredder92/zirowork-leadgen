...
const authLabel = { fontSize: 12, fontWeight: 600, color: 'var(--text-2)', marginBottom: 6, display: 'block' };
...
function AuthError({ msg }) {
  if (!msg) return null;
  return <div style={{ fontSize: 13, color: '#ef4444', padding: '8px 12px', background: 'rgba(239,68,68,0.08)', borderRadius: 6, border: '1px solid rgba(239,68,68,0.2)' }}>{msg}</div>;
}
