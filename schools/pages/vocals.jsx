            ...
            <div className="swipe-row">
              {CROSS.map((c, i) => (
                <div key={i} style={{ padding: '32px 28px', background: '#fff', borderRadius: 16, border: '1.5px solid #d0d0ce', boxShadow: '0 2px 8px rgba(0,0,0,0.07)' }}>
                  ...
                  <div style={{ fontSize: 17, fontWeight: 700, color: '#1a1a1a', marginBottom: 10, lineHeight: 1.3 }}>{c.title}</div>
                  <div style={{ fontSize: 14, color: '#666', lineHeight: 1.75 }}>{c.body}</div>
                </div>
              ))}
            </div>
          </div>
