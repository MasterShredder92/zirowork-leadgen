      ...
      <Layout school={school} intakeUrl={intakeUrl} instrument="guitar">
        ...
        <section style={{ background: 'linear-gradient(135deg, #0f0e1a 0%, #1a1535 50%, #0d1f4a 100%)', color: '#fff', padding: '80px 24px 0' }}>
          <div style={{ maxWidth: 860, margin: '0 auto', textAlign: 'center' }}>
            ...
            {/* Primary CTA */}
            <a href={intakeUrl} style={{ display: 'inline-block', padding: '16px 44px', background: accent, color: '#fff', borderRadius: 50, fontSize: 17, fontWeight: 700, textDecoration: 'none', boxShadow: '0 4px 24px rgba(0,0,0,0.3)', letterSpacing: '-0.01em' }}>
            ...
            <div className="swipe-row">
              {TEACHERS.map((t, i) => (
                <div key={i} style={{ padding: '32px 28px', background: '#f8f8f6', borderRadius: 16, border: '1.5px solid #d0d0ce', boxShadow: '0 2px 8px rgba(0,0,0,0.07)', display: 'flex', flexDirection: 'column', gap: 16 }}>
                  ...
                  <a href={intakeUrl} style={{ marginTop: 'auto', fontSize: 14, fontWeight: 700, color: accent, textDecoration: 'none' }}>
                    This sounds like me →
                  </a>
                </div>
              ))}
        ...
        <section style={{ padding: '80px 24px', background: '#fff' }}>
          <div style={{ maxWidth: 1060, margin: '0 auto' }}>
            ...
            <div style={{ textAlign: 'center', marginTop: 52 }}>
              <a href={intakeUrl} style={{ display: 'inline-block', padding: '15px 44px', background: accent, color: '#fff', borderRadius: 50, fontSize: 16, fontWeight: 700, textDecoration: 'none', letterSpacing: '-0.01em' }}>
                Sign Up Now →
              </a>
            </div>
          </div>
        ...
        <section style={{ padding: '96px 24px', background: accent, textAlign: 'center' }}>
          <div style={{ maxWidth: 600, margin: '0 auto' }}>
            ...
            <a href={intakeUrl} style={{ display: 'inline-block', padding: '16px 44px', background: '#fff', color: accent, borderRadius: 50, fontSize: 17, fontWeight: 700, textDecoration: 'none', letterSpacing: '-0.01em' }}>
              Get Signed Up Now →
            </a>
