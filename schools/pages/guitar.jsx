    ...
    <React.Fragment>
      ...
      <Layout school={school} intakeUrl={intakeUrl} instrument="guitar">
        ...
        <section style={{ padding: '80px 24px', background: '#fff' }}>
          <div style={{ maxWidth: 860, margin: '0 auto', textAlign: 'center' }}>
            <div style={{ display: 'inline-block', background: accent + '18', color: accent, padding: '3px 12px', borderRadius: 20, fontSize: 11, fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 16 }}>Don't Just Take Our Word For It</div>
        ...
        <section style={{ padding: '80px 24px', background: '#f8f8f6' }}>
          <div style={{ maxWidth: 720, margin: '0 auto', textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 15, color: '#888', margin: 0, lineHeight: 1.75 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {FAQS.map((f, i) => (
                <div key={i} style={{ background: '#f8f8f6', borderRadius: 12, border: '1.5px solid #d8d8d6', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', overflow: 'hidden' }}>
                  ...
                  {openFaq === i && (
                    <div style={{ padding: '0 24px 20px', fontSize: 14, color: '#555', lineHeight: 1.75, borderTop: '1px solid #e8e8e6' }}>{f.a}</div>
                  )}
                </div>
              ))}
            </div>
