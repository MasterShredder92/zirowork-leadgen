...
NEXT: Phase 3.14 — port next view. 13 passing (insights, bookings, reporting, settings, pages, enrollments, automation-rules, escalations, integrations, conversations, leads, campaigns, command-center). Remaining (5 operator views): clients(597), studio-map(448/vis.js—defer), onboarding(disambiguate dead vs live + cross-surface first), schools, dashboard.
