...
```
pages.jsx                  — main view, page list + config, exports window.PagesView
signup-page-blueprint.md   — design reference doc (read-only, do not modify)
```
...
## Load only
`04-pages/pages.jsx` — nothing else.
`signup-page-blueprint.md` is a reference doc — read only if task explicitly asks about page design spec.
